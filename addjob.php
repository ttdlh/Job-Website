              ...
              if($_POST['contact'] != ''){
                if(is_numeric($_POST['salary'])){
                  ...
                  $query= 'insert into job_offer(job_title, company, category, address, street, city, job_description,
                   job_requirements, salary, contact_info, image, type, username)
                    VALUES("'. $_POST['job_title'] .'", "'. $_POST['company'] .'", '. $_POST['category'] .',
                     "'. $_POST['address'] .'", "'. $_POST['street'] .'", "'. $_POST['city'] .'",
                      "'. $_POST['description'] .'", "'. $_POST['requirements'] .'", '. $_POST['salary'] .',
                       "'. $_POST['contact'] .'", "'. $_POST['image'] .'", '. $_POST['type'] .', "'. $_SESSION['username'] .'")';
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="fourm-group col-4 row">
            <input class="form-control col-2" id="parttime" type="radio" name="category" value="0" checked="checked"><!-- Part time-->
        ...
        <div class="form-group row">
          ...
          <div class="fourm-group col-4 row">
            <input class="form-control col-2" id="notsponsored" type="radio" name="type" value="0" checked=checked><!-- Not sponsored -->
            <label class="form0control-label col-10" for"notsponsored">No</lablel>
          </div>
          <div class="fourm-group col-4 row">
            <input class="form-control col-2" id="sponsored" type="radio" name="type" value="1"><!-- Sponsored -->
